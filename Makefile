...
# ===== Build Targets =====
.PHONY: release debug asan tsan coverage coverage-clang format tidy clean package
...
clean:
	@rm -rf $(BUILD_DIR) $(BUILD_DIR_ASAN) $(BUILD_DIR_TSAN) $(BUILD_DIR_COV) $(COVERAGE_OUTPUT_DIR)
